...
namespace Hotel_Management_System
{
    public partial class GuestForm : Form
    {
        ...
        private void button_save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (insertGuest)
                    {
                        MessageBox.Show("Guest saved successfuly", "Guest Saved", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        getTable();
                        // clear all text after the save action
                        button_clean.PerformClick();
                    }
                    else
                    {
                        MessageBox.Show("ERROR - Guest has not been inserted into the database", "Error Save", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch (Exception ex)
                {
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (deleteGuest)
                    {
                        MessageBox.Show("Guest data removed successfuly", "Guest Removed", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        getTable();
                    ...
                    {
                        MessageBox.Show("ERROR - Guest has not been removed from the database", "Error delete", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch (Exception ex)
                {
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (editGuest)
                    {
                        MessageBox.Show("Guest data updated successfuly", "Update Successfuly", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        getTable();
                        button_clean.PerformClick();
                    }
                    else
                    {
                        MessageBox.Show("ERROR - Guest's data has not been updated into the database", "Error Update", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch (Exception ex)
                {
        ...
        //Display the selected cell data from datagridview to textboxes;
